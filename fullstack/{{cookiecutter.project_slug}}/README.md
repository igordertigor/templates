...
Before starting Authentik, generate a client ID for your application:
...
This client ID will be used by the blueprint to create the OAuth2 provider.

#### Step 2: Complete Authentik initial setup
...
#### Step 3: Verify blueprint was applied
