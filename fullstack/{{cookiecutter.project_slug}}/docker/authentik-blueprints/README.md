...
**Configuration:**
- **Client ID**: Read from `AUTHENTIK_CLIENT_ID` environment variable
- **Client Secret**: Auto-generated by Authentik (retrieve from admin UI)
...
**Requirements:**
- `AUTHENTIK_CLIENT_ID` must be set in `.env` before Authentik starts
